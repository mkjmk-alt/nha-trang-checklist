...
- 체크 즉시 서버 저장, 활동에 따라 15→30→60초로 느려지는 가변 폴링
...
페이지 진입·새로고침·화면 복귀·온라인 복구 시에는 즉시 동기화합니다. 이후 최근 2분 동안 활동이 있으면 15초, 2~10분 동안 변화가 없으면 30초, 10분 이상 변화가 없으면 60초 간격으로 확인합니다. 체크하거나 상대방의 새 변경을 받으면 다시 15초 단계로 돌아갑니다.
